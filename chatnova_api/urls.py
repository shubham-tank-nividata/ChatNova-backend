...
from .views import PostRetriveUpdateDeleteView,CommentListCreateView, LikeList, UserPostListCreateView, followingPostList, LikeCreateRetriveDeleteView, CommentRetriveUpdateDeleteView
...
urlpatterns = [
    ...
    path('posts/<int:pk>/',PostRetriveUpdateDeleteView.as_view(), name='post-detail'),
